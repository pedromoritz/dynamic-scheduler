...
class Node:
  ...
  def get_metrics(self, node_name):
    ...
    ret_metrics = api_client.call_api('/apis/metrics.k8s.io/v1beta1/nodes/ppgcc-02', 'GET', auth_settings=['BearerToken'], response_type='json', _preload_content=False)
