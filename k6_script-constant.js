...
export function handleSummary(data) {
  return {
    [`results/summary_${__ENV.ST}_${__ENV.PA}_${__ENV.TA}_${__ENV.RT}_${__ENV.DI}.html`]: reportHTML(data, {title:`${__ENV.ST} - ${__ENV.PA} pods - ${__ENV.TA} requests per second with ${__ENV.DI} distribution`})
  };
}
