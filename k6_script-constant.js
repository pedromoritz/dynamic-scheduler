...
let summaryKey = `results/summary_${__ENV.ST}_${__ENV.PA}_${__ENV.TA}_${__ENV.RT}_${__ENV.DI}.html`;
let summaryValue = `${__ENV.ST} - ${__ENV.PA} pods - ${__ENV.TA} requests per second with ${__ENV.DI} distribution`

if (__ENV.ME) {
  summaryKey = `results/summary_${__ENV.ST}_${__ENV.PA}_${__ENV.TA}_${__ENV.RT}_${__ENV.DI}_${__ENV.ME}.html`;
  summaryValue = `${__ENV.ST} - ${__ENV.PA} pods - ${__ENV.TA} requests per second with ${__ENV.DI} distribution (${__ENV.ME} as metric)`;
}
